...
const A = {
  ...
  nav: { display: "flex", overflowX: "auto", borderBottom: "1px solid #111", background: "#0a0a0a" },
  navBtn: { flexShrink: 0, padding: "12px 14px", background: "none", border: "none", cursor: "pointer", fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: 11, letterSpacing: 1 },
