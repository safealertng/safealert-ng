...
import SafeConvoy from "./convoy/SafeConvoy";
...
export default function MainApp({ session }) {
    ...
    try {
      ...
      try {
        ...
        recorder.onstop = async () => {
          ...
          if (dbError) { console.error("DB insert error:", dbError); return; }
          setVideoSaved(true);
          console.log("Video saved to incidents!");
        };
        recorder.start(1000);
  ...
  // ── ONBOARDING ───────────────────────────────────────────────────────────
  const SLIDES = [
    { icon: "🚨", color: "#FF2D2D", title: "PANIC BUTTON", subtitle: "One tap emergency", tag: "POLICE · FAMILY · LIVE VIDEO", body: "Hold the PANIC button to instantly alert Police, Family & Emergency Services with your live GPS location and video broadcast." },
    { icon: "👨‍👩‍👧‍👦", color: "#00FF88", title: "FAMILY TRACKER", subtitle: "Live GPS for loved ones", tag: "LIVE GPS · SHAKE-TO-SOS", body: "Monitor your family's real-time location. Any member can shake their phone 3× for a silent SOS — you'll get their live GPS instantly." },
    { icon: "🔒", color: "#4A90D9", title: "ANONYMOUS TIPS", subtitle: "Report threats safely", tag: "ZERO IDENTITY · ENCRYPTED", body: "Submit intelligence to Police, DSS, Army or NSCDC with zero identity stored. No name, no IP, no trace — your safety is protected." },
    { icon: "📰", color: "#FFB800", title: "SECURITY NEWS", subtitle: "Live threat intelligence", tag: "VERIFIED · REAL-TIME · NIGERIA", body: "Stay informed with live security news from verified sources across all 36 states. Urgent alerts are pushed instantly to keep you ahead of threats." },
    { icon: "🗺️", color: "#9B59B6", title: "SAFETY MAP", subtitle: "Know your risk level", tag: "36 STATES · LIVE INCIDENTS", body: "See real-time safety risk levels across Nigeria by state and zone. Live incident data updates the map so you always know where it's safe to travel." },
    { icon: "🆘", color: "#FF6B00", title: "RANSOM ALERT", subtitle: "If a loved one is taken", tag: "CASE LOG · RECOVERY AGENTS", body: "Open a secure case file, log all kidnapper communications, and connect with verified recovery agents and all 36 state police commands instantly." },
    { icon: "🏠", color: "#00BFFF", title: "HOME SCREEN", subtitle: "Your security command center", tag: "PANIC · QUICK ACTIONS · ALERTS", body: "The home screen has the Panic button at the center, quick action tiles below, your family strip at the top, and live nearby alerts at the bottom." },
    { icon: "👤", color: "#FF69B4", title: "YOUR PROFILE", subtitle: "Set up your account", tag: "NAME · STATE · PHOTO · ADMIN", body: "Tap your avatar top right to open your profile. Set your name, state and photo. Admin Dashboard is also accessed from here." },
    { icon: "📡", color: "#00FF88", title: "LIVE ALERTS", subtitle: "Real-time community reports", tag: "FILTER · STATE · THREAT TYPE", body: "See real-time incidents reported by your community. Filter by state and threat type. Share any alert directly to WhatsApp with one tap." },
  ];
  ...
  if (showOnboarding) {
    ...
    return (
      <div style={{ background: "#080808", minHeight: "100vh", fontFamily: "'Barlow Condensed',sans-serif", color: "#fff", maxWidth: 430, margin: "0 auto", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", padding: "40px 24px 48px", position: "relative" }}>
        <style>{`@import url('https://fonts.googleapis.com/css2?family=Barlow+Condensed:wght@400;600;700;800;900&display=swap'); * { box-sizing:border-box; margin:0; padding:0; } @keyframes spin { to { transform: rotate(360deg); } }`}</style>
