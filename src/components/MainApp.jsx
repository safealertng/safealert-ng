...
const STATES = [
  ...
  { state:"Gombe", zone:"North East", police:{ command:"Gombe State Police Command", number:"08033423457", commissioner:"CP Ibrahim Musa" }, agencies:[{name:"NSCDC Gombe",number:"08036678901",icon:"⚔️"},{name:"DSS Gombe",number:"08033016789",icon:"🛡️"},{name:"FRSC Gombe",number:"08039488888",icon:"🚦"},{name:"SEMA Gombe",number:"08035789012",icon:"🆘"},{name:"FTH Gombe",number:"08037698765",icon:"🏥"}]},
  { state:"Imo", zone:"South East", police:{ command:"Imo State Police Command", number:"08033434568", commissioner:"CP Hassana Kwabi" }, agencies:[{name:"NSCDC Imo",number:"08036679012",icon:"⚔️"},{name:"DSS Imo",number:"08033017890",icon:"🛡️"},{name:"Imo Vigilante",number:"08035890123",icon:"👁️"},{name:"FRSC Imo",number:"08039489999",icon:"🚦"},{name:"IMSUTH Emergency",number:"08037609876",icon:"🏥"}]},
  { state:"Jigawa", zone:"North West", police:{ command:"Jigawa State Police Command", number:"08033445679", commissioner:"CP Idris Dauda" }, agencies:[{name:"NSCDC Jigawa",number:"08036670123",icon:"⚔️"},{name:"DSS Jigawa",number:"08033018901",icon:"🛡️"},{name:"Hisbah Board Jigawa",number:"08035901234",icon:"☪️"},{name:"FRSC Jigawa",number:"08039480000",icon:"🚦"},{name:"FMCB Emergency",number:"08037610987",icon:"🏥"}]},
  { state:"Kaduna", zone:"North West", police:{ command:"Kaduna State Police Command", number:"08033456781", commissioner:"CP Mustapha Bala" }, agencies:[{name:"NSCDC Kaduna",number:"08036671234",icon:"⚔️"},{name:"DSS Kaduna",number:"08033019012",icon:"🛡️"},{name:"FRSC Kaduna",number:"08039481111",icon:"🚦"},{name:"KADIRS Security",number:"08035012345",icon:"🛡️"},{name:"ABUTH Zaria Emergency",number:"08037621098",icon:"🏥"}]},
  { state:"Kano", zone:"North West", police:{ command:"Kano State Police Command", number:"08033467892", commissioner:"CP Usaini Gumel" }, agencies:[{name:"NSCDC Kano",number:"08036672345",icon:"⚔️"},{name:"DSS Kano",number:"08033020123",icon:"🛡️"},{name:"Hisbah Board Kano",number:"08035123456",icon:"☪️"},{name:"FRSC Kano",number:"08039482222",icon:"🚦"},{name:"AKTH Emergency",number:"08037632109",icon:"🏥"}]},
